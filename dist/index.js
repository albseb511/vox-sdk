...
var require_delayed_stream = __commonJS({
    "node_modules/delayed-stream/lib/delayed_stream.js": function(exports2, module2) {
...
var require_combined_stream = __commonJS({
    "node_modules/combined-stream/lib/combined_stream.js": function(exports2, module2) {
        var util2 = require("util");
        var Stream = require("stream").Stream;
        ...
        CombinedStream.prototype.append = function(stream4) {
            ...
            if (isStreamLike) {
                if (!_instanceof(stream4, DelayedStream)) {
...
var require_db = __commonJS({
    "node_modules/mime-db/db.json": function(exports2, module2) {
        module2.exports = {
...
var require_mime_db = __commonJS({
    "node_modules/mime-db/index.js": function(exports2, module2) {
        module2.exports = require_db();
    }
});
// node_modules/mime-types/index.js
var require_mime_types = __commonJS({
    "node_modules/mime-types/index.js": function(exports2) {
        "use strict";
...
var require_defer = __commonJS({
    "node_modules/asynckit/lib/defer.js": function(exports2, module2) {
...
var require_async = __commonJS({
    "node_modules/asynckit/lib/async.js": function(exports2, module2) {
...
var require_abort = __commonJS({
    "node_modules/asynckit/lib/abort.js": function(exports2, module2) {
...
var require_iterate = __commonJS({
    "node_modules/asynckit/lib/iterate.js": function(exports2, module2) {
...
var require_state = __commonJS({
    "node_modules/asynckit/lib/state.js": function(exports2, module2) {
...
var require_terminator = __commonJS({
    "node_modules/asynckit/lib/terminator.js": function(exports2, module2) {
        var abort = require_abort();
        var async = require_async();
...
var require_parallel = __commonJS({
    "node_modules/asynckit/parallel.js": function(exports2, module2) {
...
var require_serialOrdered = __commonJS({
    "node_modules/asynckit/serialOrdered.js": function(exports2, module2) {
        var iterate = require_iterate();
        var initState = require_state();
        var terminator = require_terminator();
...
var require_serial = __commonJS({
    "node_modules/asynckit/serial.js": function(exports2, module2) {
...
var require_asynckit = __commonJS({
    "node_modules/asynckit/index.js": function(exports2, module2) {
        module2.exports = {
...
var require_populate = __commonJS({
    "node_modules/form-data/lib/populate.js": function(exports2, module2) {
...
var require_form_data = __commonJS({
    "node_modules/form-data/lib/form_data.js": function(exports2, module2) {
...
var require_proxy_from_env = __commonJS({
    "node_modules/proxy-from-env/index.js": function(exports2) {
        "use strict";
        var parseUrl = require("url").parse;
        var DEFAULT_PORTS = {
            ftp: 21,
...
var require_node = __commonJS({
    "node_modules/debug/src/node.js": function(exports2, module2) {
        ...
        exports2.load = load;
        exports2.useColors = useColors;
        exports2.destroy = util2.deprecate(function() {}, "Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`.");
        exports2.colors = [
            6,
            2,
            3,
        ...
        function log() {
            ...
            var _util2;
            return process.stderr.write((_util2 = util2).format.apply(_util2, _to_consumable_array(args)) + "\n");
        }
        function save(namespaces) {
            if (namespaces) {
...
var require_debug = __commonJS({
    "node_modules/follow-redirects/debug.js": function(exports2, module2) {
        var debug;
...
var require_follow_redirects = __commonJS({
    "node_modules/follow-redirects/index.js": function(exports2, module2) {
...
function forEach(obj2, fn) {
    ...
    if (isArray(obj2)) {
        ...
        var keys = allOwnKeys ? Object.getOwnPropertyNames(obj2) : Object.keys(obj2);
        var len = keys.length;
        var key;
        for(i = 0; i < len; i++){
            key = keys[i];
...
var forEachEntry = function(obj2, fn) {
...
var reduceDescriptors = function(obj2, reducer) {
...
var freezeMethods = function(obj2) {
    reduceDescriptors(obj2, function(descriptor, name) {
        if (isFunction(obj2) && [
            "arguments",
            "caller",
            "callee"
...
var toJSONObject = function(obj2) {
...
var platform_default = _object_spread({}, utils_exports, node_default);
...
function fromDataURI(uri, asBlob, options) {
    var _Blob = options && options.Blob || platform_default.classes.Blob;
...
var AxiosTransformStream = /*#__PURE__*/ function(_import_stream_default_Transform) {
    ...
    var _super = _create_super(AxiosTransformStream);
    function AxiosTransformStream(options) {
        _class_call_check(this, AxiosTransformStream);
        var _this;
        options = utils_default.toFlatObject(options, {
            maxRate: 0,
            chunkSize: 64 * 1024,
        ...
        var self2 = _assert_this_initialized(_this);
    ...
    _create_class(AxiosTransformStream, [
        {
            key: "_read",
            value: function _read(size) {
                ...
                return _get(_get_prototype_of(AxiosTransformStream.prototype), "_read", this).call(this, size);
            }
        },
        {
            key: "_transform",
...
var readBlob = function() {
    var _ref = _wrap_async_generator(function(blob) {
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        5,
                        _ts_values(_async_generator_delegate(_async_iterator(blob.stream()), _await_async_generator))
                    ];
                case 1:
                    _state.sent();
                    return [
                ...
                case 2:
                    ...
                    return [
                        4,
                        _await_async_generator(blob.arrayBuffer())
                    ];
                case 3:
                    return [
                        4,
                ...
                case 5:
                    if (!blob[asyncIterator]) return [
                        3,
                        7
                    ];
                    return [
                        5,
                        _ts_values(_async_generator_delegate(_async_iterator(blob[asyncIterator]()), _await_async_generator))
                    ];
                case 6:
                    _state.sent();
                    return [
...
var FormDataPart = /*#__PURE__*/ function() {
    ...
    function FormDataPart(name, value) {
        _class_call_check(this, FormDataPart);
        var escapeName = this.constructor.escapeName;
        var isStringValue = utils_default.isString(value);
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                _state.sent();
                                value = _this.value;
                                if (!utils_default.isTypedArray(value)) return [
                                    3,
                                    3
                                ];
                                return [
                            ...
                            case 3:
                                return [
                                    5,
                                    _ts_values(_async_generator_delegate(_async_iterator(readBlob_default(value)), _await_async_generator))
                                ];
                            case 4:
                                _state.sent();
                                _state.label = 5;
...
var formDataToStream = function(form, headersHandler, options) {
    var _ref = options || {}, _ref_tag = _ref.tag, tag = _ref_tag === void 0 ? "form-data-boundary" : _ref_tag, _ref_size = _ref.size, size = _ref_size === void 0 ? 25 : _ref_size, _ref_boundary = _ref.boundary, boundary = _ref_boundary === void 0 ? tag + "-" + utils_default.generateString(size, BOUNDARY_ALPHABET) : _ref_boundary;
    ...
    var parts = Array.from(form.entries()).map(function(param) {
    ...
    return import_stream2.Readable.from(_wrap_async_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 3:
                    ...
                    return [
                        5,
                        _ts_values(_async_generator_delegate(_async_iterator(part.encode()), _await_async_generator))
                    ];
                case 4:
                    _state.sent();
                    _state.label = 5;
...
var ZlibHeaderTransformStream = /*#__PURE__*/ function(_import_stream3_default_Transform) {
    "use strict";
    _inherits(ZlibHeaderTransformStream, _import_stream3_default_Transform);
    var _super = _create_super(ZlibHeaderTransformStream);
    function ZlibHeaderTransformStream() {
        _class_call_check(this, ZlibHeaderTransformStream);
        return _super.apply(this, arguments);
    }
    _create_class(ZlibHeaderTransformStream, [
        {
            key: "__transform",
...
}(import_stream3.default.Transform);
var ZlibHeaderTransformStream_default = ZlibHeaderTransformStream;
// node_modules/axios/lib/helpers/callbackify.js
var callbackify = function(fn, reducer) {
    return utils_default.isAsyncFn(fn) ? function callbackify() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        var cb = args.pop();
        fn.apply(this, args).then(function(value) {
            try {
                reducer ? cb.apply(void 0, [
                    null
                ].concat(_to_consumable_array(reducer(value)))) : cb(null, value);
            } catch (err) {
                cb(err);
            }
        }, cb);
...
var isHttps = /https:?/;
var supportedProtocols = platform_default.protocols.map(function(protocol) {
    return protocol + ":";
});
...
var resolveFamily = function(param) {
    var address = param.address, family = param.family;
...
var buildAddressEntry = function(address, family) {
    return resolveFamily(utils_default.isObject(address) ? address : {
        address: address,
        family: family
    });
};
var http_default = isHttpAdapterSupported && function httpAdapter(config) {
    return wrapAsync(function() {
        var _dispatchHttpRequest = _async_to_generator(function(resolve, reject, onDone) {
            var data, lookup, family, responseType, responseEncoding, method, isDone, rejected, req, _lookup, emitter, onFinished, fullPath, parsed, protocol, convertedData, headers, onDownloadProgress, onUploadProgress, maxRate, maxUploadRate, maxDownloadRate, userBoundary, knownLength, e, contentLength, auth, username, password, urlUsername, urlPassword, path, customErr, options, transport, isHttpsRequest, timeout, ended, errored;
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        rejected = false;
                        if (lookup) {
                            _lookup = callbackify_default(lookup, function(value) {
                                return utils_default.isArray(value) ? value : [
                                    value
                                ];
                            });
                            lookup = function(hostname, opt, cb) {
                                _lookup(hostname, opt, function(err, arg0, arg1) {
                                    var addresses = utils_default.isArray(arg0) ? arg0.map(function(addr) {
                        ...
                        headers = AxiosHeaders_default.from(config.headers).normalize();
                        headers.set("User-Agent", "axios/" + VERSION, false);
                        onDownloadProgress = config.onDownloadProgress;
                        onUploadProgress = config.onUploadProgress;
                        maxRate = config.maxRate;
                        maxUploadRate = void 0;
                        maxDownloadRate = void 0;
                        if (!utils_default.isSpecCompliantForm(data)) return [
                            3,
                            1
                        ];
                        userBoundary = headers.getContentType(/boundary=([-_\w\d]{10,70})/i);
                        data = formDataToStream_default(data, function(formHeaders) {
                    ...
                    case 1:
                        if (!(utils_default.isFormData(data) && utils_default.isFunction(data.getHeaders))) return [
                            3,
                            6
                        ];
                        headers.set(data.getHeaders());
                        if (!!headers.hasContentLength()) return [
                            3,
                            5
                        ];
                        _state.label = 2;
                    case 2:
                        ...
                        return [
                            4,
                            import_util2.default.promisify(data.getLength).call(data)
                        ];
                    case 3:
                        knownLength = _state.sent();
                    ...
                    case 6:
                        if (utils_default.isBlob(data)) {
                            ...
                            if (Buffer.isBuffer(data)) {} else if (utils_default.isArrayBuffer(data)) {
                                ...
                                return [
                                    2,
                                    reject(new AxiosError_default("Data after transformation must be a string, an ArrayBuffer, a Buffer, or a Stream", AxiosError_default.ERR_BAD_REQUEST, config))
                                ];
                            }
                            ...
                            if (config.maxBodyLength > -1 && data.length > config.maxBodyLength) {
                                return [
                                    2,
                                    reject(new AxiosError_default("Request body larger than maxBodyLength limit", AxiosError_default.ERR_BAD_REQUEST, config))
                                ];
                            }
                        }
                        _state.label = 7;
                    case 7:
                        contentLength = utils_default.toFiniteNumber(headers.getContentLength());
                        ...
                        req = transport.request(options, function handleResponse(res) {
                            ...
                            var offListeners = import_stream4.default.finished(responseStream, function() {
                                offListeners();
                                onFinished();
                            });
                            var response = {
        ...
        function dispatchHttpRequest(resolve, reject, onDone) {
...
var isURLSameOrigin_default = platform_default.hasStandardBrowserEnv ? // Standard browser envs have full support of the APIs needed to test
    ...
    return new Promise(function dispatchXhrRequest(resolve, reject) {
        ...
        if (platform_default.hasStandardBrowserEnv) {
            ...
            if (withXSRFToken || withXSRFToken !== false && isURLSameOrigin_default(fullPath)) {
                var xsrfValue = config.xsrfHeaderName && config.xsrfCookieName && cookies_default.read(config.xsrfCookieName);
                if (xsrfValue) {
...
var VoxProvider = function(param) {
    var children = param.children, config = param.config;
    var _ref = _sliced_to_array((0, import_react.useState)(null), 2), token = _ref[0], setToken = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react.useState)(null), 2), region = _ref1[0], setRegion = _ref1[1];
    var lastCallRef = (0, import_react.useRef)(0);
    var apiRef = (0, import_react.useRef)(createApi(config === null || config === void 0 ? void 0 : config.baseUrl));
    var getAuthTokenAzure2 = import_react.default.useCallback(/*#__PURE__*/ _async_to_generator(function() {
        var response, _response_data, newToken, newRegion;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    if (token && region && Date.now() - lastCallRef.current < 10 * 60 * 1e3) {
                        return [
                            2,
                            {
                                token: token,
                    ...
                    return [
                        4,
                        axios_default2.get("/token")
                    ];
                case 1:
                    response = _state.sent();
                    _response_data = response.data, newToken = _response_data.token, newRegion = _response_data.region;
                    setToken(newToken);
                    setRegion(newRegion);
    ...
    var contextValue = {
        getAuthTokenAzure: getAuthTokenAzure2,
        token: token,
        region: region
    };
...
var useAppContext = function() {
    var context = (0, import_react.useContext)(AppContext);
    if (!context) {
...
var useToken = function() {
    ...
    var _useAppContext = useAppContext(), getAuthTokenAzure2 = _useAppContext.getAuthTokenAzure, token = _useAppContext.token, region = _useAppContext.region;
            ...
            var _ref = _async_to_generator(function() {
                ...
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 2:
                            err = _state.sent();
                            setError(_instanceof(err, Error) ? err : new Error("Failed to fetch token"));
                            return [
                                3,
                                4
                            ];
...
var sdk = __toESM(require("microsoft-cognitiveservices-speech-sdk"));
var import_use_debounce = require("use-debounce");
function useListen(param) {
    var onEndOfSpeech = param.onEndOfSpeech, isAiSpeaking = param.isAiSpeaking, _param_automatedEnd = param.automatedEnd, automatedEnd = _param_automatedEnd === void 0 ? true : _param_automatedEnd, _param_delay = param.delay, delay = _param_delay === void 0 ? 2e3 : _param_delay;
    var _ref = _sliced_to_array((0, import_react2.useState)(false), 2), userHasNotSpoken = _ref[0], setUserHasNotSpoken = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react2.useState)([]), 2), answers = _ref1[0], setAnswers = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react2.useState)(""), 2), answer = _ref2[0], setAnswer = _ref2[1];
    var _ref3 = _sliced_to_array((0, import_react2.useState)(false), 2), loading = _ref3[0], setLoading = _ref3[1];
    var _ref4 = _sliced_to_array((0, import_react2.useState)(false), 2), endOfSpeech = _ref4[0], setEndOfSpeech = _ref4[1];
    var recognizerRef = (0, import_react2.useRef)(null);
    var isLocal = "development";
    var _useToken = useToken(), token = _useToken.token, region = _useToken.region;
    var debounced = (0, import_use_debounce.useDebouncedCallback)(function() {
                ...
                switch(_state.label){
                    case 0:
                        ...
                        if (!userHasNotSpoken) {
                            ...
                            (_recognizerRef_current = recognizerRef.current) === null || _recognizerRef_current === void 0 ? void 0 : _recognizerRef_current.close();
    ...
    var _ref5 = _sliced_to_array((0, import_react2.useState)(null), 2), config = _ref5[0], setConfig = _ref5[1];
    var startSpeechRecognition = function() {
        return new Promise(function() {
            var _ref = _async_to_generator(function(resolve, reject) {
                var audioConfig, speechConfig, speechConfig1;
                return _ts_generator(this, function(_state) {
                    ...
                    if (!config) {
                        ...
                        speechConfig1 = sdk.SpeechConfig.fromAuthorizationToken(config === null || config === void 0 ? void 0 : config.t, config === null || config === void 0 ? void 0 : config.r);
                        speechConfig1.speechSynthesisVoiceName = "en-US-GuyNeural";
                        recognizerRef.current = new sdk.SpeechRecognizer(speechConfig1, audioConfig);
                    }
                    ...
                    recognizerRef.current.canceled = function(s, e) {
                        ...
                        (_recognizerRef_current = recognizerRef.current) === null || _recognizerRef_current === void 0 ? void 0 : _recognizerRef_current.stopContinuousRecognitionAsync();
                    };
    ...
    var stopSpeechRecognition = function() {
        var _ref = _async_to_generator(function() {
            var _recognizerRef_current, _recognizerRef_current1;
            return _ts_generator(this, function(_state) {
                (_recognizerRef_current = recognizerRef.current) === null || _recognizerRef_current === void 0 ? void 0 : _recognizerRef_current.stopContinuousRecognitionAsync();
                setLoading(false);
                isLocal && console.log("closing speech - stopSpeechRecognition");
                (_recognizerRef_current1 = recognizerRef.current) === null || _recognizerRef_current1 === void 0 ? void 0 : _recognizerRef_current1.close();
                recognizerRef.current = null;
                setAnswers([]);
                setAnswer("");
                return [
        ...
        return function stopSpeechRecognition() {
            return _ref.apply(this, arguments);
        };
    }();
    (0, import_react2.useEffect)(function() {
...
var useListen_default = useListen;
// src/hooks/useSpeak.tsx
var sdk2 = __toESM(require("microsoft-cognitiveservices-speech-sdk"));
var import_react3 = __toESM(require("react"));
// src/utils/getAuthTokenAzure.ts
function getAuthTokenAzure() {
    var token = null;
    var region = null;
    var lastCall = 0;
    return /*#__PURE__*/ _async_to_generator(function() {
        var response, _response_data, t, r;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    if (token && region) {
                        if (Date.now() - lastCall < 10 * 60 * 1e3) {
                            return [
                                2,
                                {
                                    token: token,
                ...
                case 1:
                    response = _state.sent();
                    _response_data = response.data, t = _response_data.token, r = _response_data.region;
                    token = t;
                    region = r;
                    lastCall = Date.now();
                    return [
...
function useTTSwithAI(param) {
    var _param_shouldCallOnEnd = param.shouldCallOnEnd, shouldCallOnEnd = _param_shouldCallOnEnd === void 0 ? false : _param_shouldCallOnEnd, onEnd = param.onEnd;
    var _ref = _sliced_to_array((0, import_react3.useState)(false), 2), isStreaming = _ref[0], setIsStreaming = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react3.useState)(false), 2), isSpeaking = _ref1[0], setIsSpeaking = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react3.useState)(true), 2), hasAllSentencesBeenSpoken = _ref2[0], setHasAllSentencesBeenSpoken = _ref2[1];
    var _ref3 = _sliced_to_array((0, import_react3.useState)(""), 2), currentStreamedSentence = _ref3[0], setCurrentStreamedSentence = _ref3[1];
    var _ref4 = _sliced_to_array((0, import_react3.useState)([]), 2), streamedSentences = _ref4[0], setStreamedSentences = _ref4[1];
    var _ref5 = _sliced_to_array((0, import_react3.useState)(null), 2), config = _ref5[0], setConfig = _ref5[1];
    var didStreamCallbackGetCalled = (0, import_react3.useRef)(false);
    var playerRef = import_react3.default.useRef(null);
    var audioConfig = import_react3.default.useRef(null);
    var speechSythesizerRef = import_react3.default.useRef(null);
    var voice = "en-US-JennyNeural";
    var getAuthTokenAzureApi = (0, import_react3.useRef)(getAuthTokenAzure());
    var throttledCalledback = (0, import_use_debounce2.useThrottledCallback)(function(text) {
        return startTextToSpeech(text);
    }, 100);
    var isLocal = process.env.NODE_ENV === "development";
    var startTextToSpeech = function() {
        var _ref = _async_to_generator(function(text, cancelEndCallback) {
            var _playerRef_current, _playerRef_current1, _playerRef_current2, _audioConfig_current, player, _ref, _ref1, token, region, speechConfig, speechConfig1;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        if (isSpeaking) Promise.reject("Already speaking");
                        if ((_playerRef_current = playerRef.current) === null || _playerRef_current === void 0 ? void 0 : _playerRef_current.id) {
                            ;
                            (_playerRef_current1 = playerRef.current) === null || _playerRef_current1 === void 0 ? void 0 : _playerRef_current1.pause();
                            (_playerRef_current2 = playerRef.current) === null || _playerRef_current2 === void 0 ? void 0 : _playerRef_current2.close();
                            (_audioConfig_current = audioConfig.current) === null || _audioConfig_current === void 0 ? void 0 : _audioConfig_current.close();
                            playerRef.current = null;
                        }
                        player = new sdk2.SpeakerAudioDestination();
                        ...
                        audioConfig.current = sdk2.AudioConfig.fromSpeakerOutput(player);
                        ...
                        return [
                            4,
                            getAuthTokenAzureApi.current()
                        ];
                    case 1:
                        _ref1 = (_ref = _state.sent()) !== null && _ref !== void 0 ? _ref : {}, token = _ref1.token, region = _ref1.region;
                        if (!token || !region) Promise.reject("Error getting token or region");
                        setConfig({
                            t: token,
                            r: region
                        });
                        speechConfig = sdk2.SpeechConfig.fromAuthorizationToken(token, region);
                        speechConfig.speechSynthesisVoiceName = voice;
                        speechSythesizerRef.current = new sdk2.SpeechSynthesizer(speechConfig, audioConfig.current);
                        return [
                            3,
                            3
                        ];
                    case 2:
                        speechConfig1 = sdk2.SpeechConfig.fromAuthorizationToken(config === null || config === void 0 ? void 0 : config.t, config === null || config === void 0 ? void 0 : config.r);
                        speechConfig1.speechSynthesisVoiceName = voice;
                        speechSythesizerRef.current = new sdk2.SpeechSynthesizer(speechConfig1, audioConfig.current);
                        _state.label = 3;
                    case 3:
                        try {
                            speechSythesizerRef.current.speakTextAsync(text, function(result) {
                                if (result) {
                                    var _speechSythesizerRef_current, _audioConfig_current;
                                    (_speechSythesizerRef_current = speechSythesizerRef.current) === null || _speechSythesizerRef_current === void 0 ? void 0 : _speechSythesizerRef_current.close();
                                    (_audioConfig_current = audioConfig.current) === null || _audioConfig_current === void 0 ? void 0 : _audioConfig_current.close();
                                    speechSythesizerRef.current = null;
                        ...
                        return [
                            2,
                            function() {
                                var _playerRef_current, _playerRef_current1, _audioConfig_current, _speechSythesizerRef_current;
                                ...
                                (_playerRef_current1 = playerRef.current) === null || _playerRef_current1 === void 0 ? void 0 : _playerRef_current1.close();
                                (_audioConfig_current = audioConfig.current) === null || _audioConfig_current === void 0 ? void 0 : _audioConfig_current.close();
                                playerRef.current = null;
                                (_speechSythesizerRef_current = speechSythesizerRef.current) === null || _speechSythesizerRef_current === void 0 ? void 0 : _speechSythesizerRef_current.close();
                                speechSythesizerRef.current = null;
        ...
        return function startTextToSpeech(text, cancelEndCallback) {
            return _ref.apply(this, arguments);
        };
    }();
    ...
    (0, import_react3.useEffect)(function() {
        getAuthTokenAzureApi.current().then(function(param) {
            var token = param.token, region = param.region;
    ...
    var interruptSpeech = function() {
        var _speechSythesizerRef_current, _playerRef_current, _playerRef_current1, _audioConfig_current;
...
var useSpeak_default = useTTSwithAI;
// src/index.ts
var obj = {
    VoxProvider: VoxProvider,
    useListen: useListen_default,
    useAppContext: useAppContext,
    useToken: useToken,
    useSpeak: useSpeak_default
};
var src_default = obj; /*! Bundled license information:
